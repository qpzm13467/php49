...
<!-- 表格主体内容 -->
                             <tbody>
                                <?php if(is_array($reviews)): foreach($reviews as $key=>$rev): ?><tr>
                                        <td>
                                        ...
                                        <td class="hidden-phone" id="td">
                                            <?php echo ($rev["details"]); ?>
                                        </td>
                                        <td class="hidden-phone" id="td">
                                            <?php echo ($rev["title"]); ?>
                                        </td>
                                        <td class="hidden-phone">
                                            <?php echo ($rev["addtime"]); ?>
                                        </td>
                                        <td class="hidden-phone">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="/index.php/Admin/Common/delreview/id/<?php echo ($rev["id"]); ?>">删除</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>   
...
<!--页脚  -->
    ...
    <script type="text/javascript">
        ...
        var CONTROLLER="/index.php/Admin/Common";
            ...
            $.post(CONTROLLER+'/search',cname,function(cname){
                ...
                if(!cname){
                    ...
                    $.each(cname,function(i,j){
                        ...
                        str+="'dropdown-menu'";
                        str+="><li><a href=";
                        str+="'/index.php/Admin/Common/edit/id/"+j.id+"'";
                        str+=">查看或修改影片详情</a></li><li><a href=";
                        str+="'/index.php/Admin/Common/del/id/"+j.id+"'";
