                                        ...
                                        <td class="hidden-phone">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="/index.php/Admin/Review/delreview/id/<?php echo ($rev["id"]); ?>">删除</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>   
...
<!--页脚  -->
    ...
    <script type="text/javascript">
        ...
        var CONTROLLER="/index.php/Admin/Review";
            ...
            $.post(CONTROLLER+'/search',cname,function(cname){
                ...
                if(!cname){
                    ...
                    $.each(cname,function(i,j){
                        ...
                        str+="'dropdown-menu'";
                        str+="><li><a href=";
                        str+="'/index.php/Admin/Review/edit/id/"+j.id+"'";
                        str+=">查看或修改影片详情</a></li><li><a href=";
                        str+="'/index.php/Admin/Review/del/id/"+j.id+"'";
